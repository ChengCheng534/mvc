...
define('DB_HOST', 'localhost'); // Direccion del servidor de la base de datos
define('DB_USUARIO', 'root'); // Usuario de la base de datos
define('DB_PASSWORD', 'mysql'); // Pass por defecto al instalar AMMPS
define('DB_NOMBRE', 'concesionario'); //Nombre de la base de datos
