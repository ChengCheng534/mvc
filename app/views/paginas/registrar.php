...
<div class="container mt-3">
  ...
  <div class="container text-center">
        <h2 class=" mt-3 col-6 col-md-6 col-lg-6 offset-3 offset-md-3">Resgistrar como cliente:</h2>
        <form action="<?php echo RUTA_URL; ?>/Usuarios/verificarLoginPassword" method="POST" class="row mt-3 col-6 col-md-4 col-lg-4 offset-3 offset-md-4 offset-lg-4">
